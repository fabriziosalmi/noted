...
describe('EditorToolbar', () => {
  ...
  it('places shareSlot in Row 2 when showAiBar is true (regardless of showToolbar)', () => {
    ...
    // When both are true, Row 2 should have border-t styling
    const row2 = container.querySelector('.border-t');
    expect(row2).toBeInTheDocument();
    expect(row2?.contains(shareSlot)).toBe(true);
  });
