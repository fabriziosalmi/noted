...
export interface ProjectSuggestion {
  slug: string; // project slug, e.g. 'minerva'
  label: string; // display label, e.g. 'Minerva'
  tag: string; // '#project/minerva'
 ...
 *  suffix removed so "Minerva" and "Minerva 2" fold to the same project. */
